...
<head>
    ...
    <link href="<?= base_url('_assets/libs/DataTables/DataTables-1.11.3/css/dataTables.bootstrap.min.css');?>" rel="stylesheet">
    <script src="<?= base_url('_assets/js/jquery.js')?>"></script>
    <script src="<?= base_url('_assets/js/bootstrap.min.js')?>"></script> 
    <script src="<?= base_url('_assets/libs/DataTables/datatables.min.js')?>"></script> 
    <script src="<?= base_url('_assets/libs/DataTables/DataTables-1.11.3/js/dataTables.bootstrap.min.js')?>"></script> 
