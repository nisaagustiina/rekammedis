            ...
            <div align="center" style="margin-top: 210px;">
                ...
                <form action="" method="post" class="navbar-form">
                    <div class="input-group">
                        ...
                        <input type="text" name="user" id="" class="form-control" placeholder="Username" required autofocus>
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        <input type="submit" name="login" id="" class="btn btn-primary" value="Login">
                    </div>
                </form>
            </div>
        </div>
